...
return [
     ...
     */
    'title' => "air-statistic-api",

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'The application exposes end-user UI interface and backend API for an open-source dataset visualisation came from GIOŚ.',
